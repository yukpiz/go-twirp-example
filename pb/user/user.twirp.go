...
func (c *userAPIProtobufClient) GetUser(ctx context.Context, in *GetUserMessage) (*UserResponse, error) {
...
func (c *userAPIJSONClient) GetUser(ctx context.Context, in *GetUserMessage) (*UserResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "user")
	ctx = ctxsetters.WithServiceName(ctx, "UserAPI")
	ctx = ctxsetters.WithMethodName(ctx, "GetUser")
	out := new(UserResponse)
...
func NewUserAPIServer(svc UserAPI, hooks *twirp.ServerHooks) TwirpServer {
...
func (s *userAPIServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
	writeError(ctx, resp, err, s.hooks)
}

// UserAPIPathPrefix is used for all URL paths on a twirp UserAPI server.
// Requests are always: POST UserAPIPathPrefix/method
// It can be used in an HTTP mux to route twirp requests along with non-twirp requests on other routes.
const UserAPIPathPrefix = "/twirp/user.UserAPI/"

func (s *userAPIServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "user")
	ctx = ctxsetters.WithServiceName(ctx, "UserAPI")
...
func (s *userAPIServer) serveGetUser(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
...
func (s *userAPIServer) serveGetUserJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetUser")
	...
	func() {
		...
		respContent, err = s.UserAPI.GetUser(ctx, reqContent)
	}()
...
func (s *userAPIServer) serveGetUserProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetUser")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *userAPIServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *userAPIServer) ProtocGenTwirpVersion() string {
	return "v5.7.0"
}

func (s *userAPIServer) PathPrefix() string {
	return UserAPIPathPrefix
}
